...
class TransformerRCReader(DatasetReader):
    ...
    def __init__(
        ...
        **kwargs
        ...
        kwargs.pop("fill_in_placeholder_words")
        kwargs.pop("truncate_question_text")
        kwargs.pop("use_last_question_node_only")
        kwargs.pop("sample_any_para_having_answer")
        kwargs.pop("use_context_entities_only")
        kwargs.pop("add_word_overlap_rank")
        kwargs.pop("skip_num_hops_except")
